...
const docTemplate = `{
        ...
        "/statistics": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Фильтрация статистики по конкректному пользователю",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Конец промежутка рассмотрения статистики (не включительно), форматЖ YYYY-MM-DD",
                        "name": "to",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_simonkefir_golang-todoapp_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Фильтра задач по ID автора",
                        "name": "user_id",
                        "in": "query"
                    },
                    {
    ...
    "definitions": {
        "github_com_simonkefir_golang-todoapp_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string",
